...
const EXAM_ID = "nda";
const EXAM_DISPLAY_NAME = "NDA (National Defence Academy Examination)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Mathematics and General Ability Test (English + General Knowledge). Align to UPSC NDA syllabus.
