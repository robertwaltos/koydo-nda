...
export const metadata: Metadata = {
  title: "Pricing — Nda Premium",
  description: "Unlock unlimited Nda practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=nda&cadence=annual`;
